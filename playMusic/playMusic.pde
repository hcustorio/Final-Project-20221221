...
void setup () {
  ...
  minim = new Minim(this); //load from data directory, loadFile should also load from project, like loadImage
  song1 = minim.loadFile("../music used/Cycles.mp3"); //able to pass absolute path, file name & extension, and URL
}//End setup
// 
void draw() {
}//End draw
